...
## Estimation of Erro Terms Variance $\sigma^{2}$
...
|$\sgima^2$|$\hat{\sigma^2} = \frac{\sum(Y_i-\hat{Y_i})^2}{n}$|

The maximum likelihood estimator $\sgima^2$ is biased. The unbiased one is MSE or $s^2$.
